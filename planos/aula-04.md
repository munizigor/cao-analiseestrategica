...
holders    ção da     de Cená-    OBJETIVO e    ganha       vira
e teia     Oficina    rios +      INDICADOR     DADO        DECISÃO
sistêmica             DORES
                      clusteri-
                      zadas
```

A turma chegou até aqui com um monte de dores organizadas em clusters. Dor não se gerencia: o que se
gerencia é **problema com nome, dono e número**. A aula 4 faz exatamente essa travessia.
...
|---|---|
| 3.1 Conceito de indicadores de desempenho (Un. II) | Bloco 5 |
| 3.2 Importância da análise de indicadores no CBMDF (Un. II) | Blocos 4 e 5 |
| 4.1 Técnicas para atribuir pesos aos indicadores (Un. II) | Bloco 7 |
| 4.2 Importância da priorização estratégica (Un. II) | Blocos 2 e 7 |
...
### Bloco 1 — Galeria das Dores · 20 min

**Formato:** individual, em silêncio.

Os clusters já estão na parede quando a turma entra. Cada aluno recebe **3 adesivos** e a única
instrução é:

> *"Cole seus três adesivos nas dores que, se resolvidas, mais mudariam o CBMDF. Sem conversar, sem
> propor solução. Você tem 8 minutos."*

O instrutor **não fala** durante a votação. Terminada a votação, apenas anuncia em voz alta o ranking
formado, sem comentar.

**Por que assim:** é a retomada da aula 3 sem uma recapitulação expositiva. Em 20 minutos a turma
reconstrói sozinha o que produziu, e o resultado da votação vira insumo do bloco seguinte.
...
> Se for opinião, o grupo anota o porquê no campo *"hipótese a verificar na Aula 5"* e tenta outra
> resposta.
...
Se estiver, é sinal de que o problema **se realimenta** — o exemplo do ciclo de má gestão de recursos
humanos visto na Aula 1 (alocação inadequada → queda de produtividade → desmotivação em se capacitar
→ déficit de competências → alocação ainda pior) é a referência. Problemas em ciclo reforçador não
respondem a ação pontual: exigem intervenção no ponto de alavancagem, e o indicador precisa vigiar
...
### Bloco 4 — "Onde isso mora no PLANES?" · 25 min

**Atividade primeiro, exposição depois.** Com o mapa estratégico do **PLANES 2017-2024** na parede,
cada grupo tem 12 min para localizar em qual objetivo estratégico a sua dor se encaixa e escrever
essa amarração em uma frase:

> *"Nossa dor ataca o objetivo ____________ do PLANES, na perspectiva ____________."*

Se não encaixar em objetivo nenhum, o grupo registra em vermelho: **LACUNA DO PLANES**. Isso não é
erro nem preguiça — é um achado legítimo e, num plano cujo horizonte 2017-2024 já se encerrou, é um
achado provável e valioso. Grupos nessa situação escrevem qual objetivo *deveria* existir.

**Micro-exposição (12 min) — quatro palavras que a turma vai confundir a vida inteira:**

| Conceito | Pergunta que responde | Exemplo |
|---|---|---|
| **Objetivo** | Aonde queremos chegar? | Ampliar a capacidade de resposta em atendimento pré-hospitalar |
| **Meta** | Quanto e até quando? | Reduzir o tempo-resposta mediano para 8 min até dez/2027 |
| **Indicador** | Como sabemos se estamos chegando? | Tempo-resposta mediano em ocorrências de APH, em minutos |
| **Iniciativa** | O que vamos fazer? | Redistribuir viaturas por análise de densidade de chamados |
...
| Campo | A pergunta de teste |
|---|---|
| Nome | Um oficial de outra diretoria entende sem explicação? |
| **Fórmula** | Duas pessoas diferentes, com a mesma base, chegam ao mesmo número? |
| Unidade | Minutos, %, ocorrências/1.000 hab.? |
| **Fonte do dado** | De qual sistema/relatório sai? Quem digita? |
| **Dono** | Qual unidade responde por este número na reunião? |
| Periodicidade | Mensal, trimestral? Bate com a velocidade do fenômeno? |
| **Polaridade** | Maior é melhor ou pior? |
| Linha de base | Qual é o valor hoje? *Sem isso, não há como saber se melhorou.* |
| Meta | Quanto, até quando, e **por que esse número** e não outro? |
| **Comportamento induzido** | *Se a tropa souber que é medida por isto, o que ela passa a fazer?* |
...
- **Indicador de esforço/processo (*leading*)** — mede o meio, antecipa o resultado. Chega a tempo de
  corrigir, mas só vale se a relação causal com o resultado for verdadeira. *Ex.: % de edificações de
  alto risco com vistoria em dia.*
...
### Bloco 7 — "Quanto vale cada coisa?" · 30 min

**Micro-exposição (8 min).** Se o painel tem 6 indicadores e todos "importam", nada importa. Ponderar
é assumir publicamente uma prioridade. Três métodos:

1. **Distribuição de 100 pontos** — rápido, intuitivo, e é o que a maior parte das organizações faz.
   Fraqueza: pressão do grupo e ancoragem em quem fala primeiro.
2. **Comparação par a par (AHP simplificado)** — compara-se dois de cada vez, "entre A e B, qual pesa
   mais e quanto?". Mais lento, mas expõe **inconsistência**: se A > B, B > C e C > A, o grupo não
   tem um critério — tem três opiniões.
3. **Delphi** — rodadas anônimas com devolutiva, para quando há assimetria hierárquica na sala. *Numa
...
> *"O indicador que eu vou querer olhar toda segunda-feira quando eu for comandante é ______, porque
> ______."*

O instrutor lê **três** em voz alta, sem identificar autores, e encerra. Guarde as fichas: elas
voltam no painel da linha do tempo na Aula 6.
...
Nada aqui é nota fechada; a aula alimenta os componentes descritos em [`avaliacao.md`](avaliacao.md):
...
- FRANCISCHINI, A. S. N.; FRANCISCHINI, P. **Indicadores de desempenho: dos objetivos à ação.** Rio
  de Janeiro: Alta Books, 2017. *(base do bloco 5)*
- CBMDF. **Plano Estratégico do CBMDF 2017-2024.** 2. ed. Brasília, 2023. *(bloco 4)*
- CBMDF. **Caderno de Indicadores Estratégicos.** Brasília, 2015. *(blocos 4 e 5)*
- CBMDF. **Aprovação dos Indicadores Institucionais** — Portaria nº 6, de 6 de março de 2017.
- MEADOWS, D. **Pensando em Sistemas.** *(ciclos de retroalimentação — amarração do bloco 3 com a
  Aula 1)*
- MINTZBERG, H. **Ascensão e Queda do Planejamento Estratégico.** Porto Alegre: Bookman, 2004.
  *(pano de fundo do bloco 4: por que o plano perfeito no papel não vira estratégia)*
