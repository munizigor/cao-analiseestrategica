# Planos de Aula — Análise Estratégica

> **CAO/CBMDF · CEPED · 30 h/a** (20 h/a presenciais + 10 h/a a distância)
...
sistêmica                               dor
presencial    EAD          presencial   presencial   EAD           presencial
```
...
O plano de disciplina prevê 10 h/a a distância (Unidades I e II) e 20 h/a presenciais. A execução
distribuiu a modalidade EAD nas **Aulas 2 e 5** — mesma carga total (10 h/a a distância), ordem
diferente, o que preserva a conformidade com a carga horária aprovada.
...
## Restrição de projeto da Aula 5
...
Estes planos foram escritos sob uma restrição explícita do instrutor: **nada de aula em que ele fala
e a turma escuta**. As decisões que decorrem disso:

1. **Nenhuma exposição passa de 12 minutos.** O conteúdo teórico entra em micro-doses, sempre
   imediatamente aplicado.
2. **Atividade antes da teoria** sempre que possível. No bloco 4 da Aula 4, a turma procura a
   ancoragem no PLANES *antes* de ouvir a diferença entre objetivo, meta, indicador e iniciativa.
3. **A ética entra pela prática.** Em vez de uma aula sobre integridade, o Red Team da Aula 4 faz os
   alunos descobrirem sozinhos que todo indicador é burlável. Na Aula 6, eles reencontram as próprias
   burlas nos casos do Tribunal do Indicador.
4. **Decisão só se aprende decidindo sob escassez.** A regra do envelope de 100 fichas na RAE — não
   há recurso para todos os grupos — é o que separa o exercício da simulação real.
5. **Todo produto de uma aula é insumo da seguinte.** Nada é descartado; nada é feito "para
   exercitar".
6. **Avaliação com rubrica aberta**, devolvida preenchida ao avaliado. Rubrica que não volta é
   burocracia.
...
- FRANCISCHINI, A. S. N.; FRANCISCHINI, P. **Indicadores de desempenho: dos objetivos à ação —
...
- MAQUIAVEL, N. **O Príncipe.** Rio de Janeiro: Civilização Brasileira, 1972.
- MEADOWS, D. **Pensando em Sistemas.**
- FREITAS, M. T. **Business Intelligence para gestão de indicadores de desempenho e suporte à tomada
  de decisão.** UFOP, 2021.
- CBMDF. **Plano Estratégico do CBMDF 2017-2024.** 2. ed. Brasília, 2023.
- CBMDF. **Caderno de Indicadores Estratégicos.** Brasília, 2015.
- CBMDF. **Caderno de Indicadores de Governança.** Brasília, 2020.
- CBMDF. **Aprovação dos Indicadores Institucionais** — Portaria nº 6, de 6 de março de 2017.
- CBMDF. **Projetos Estratégicos para o PLANES 2017-2024** — BG nº 111, de 14 de junho de 2022.
